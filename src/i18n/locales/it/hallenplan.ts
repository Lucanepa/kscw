export default {
  ...
  hallDeleteConfirm: 'Eliminare "{{name}}"? L\'operazione non puo essere annullata.',
  hallsEmpty: 'Nessuna palestra',
  hallImpactRemoved: 'Eliminato con essa:',
  hallImpactKept: 'Mantenuto, ma senza palestra:',
  hallImpactSlots: '{{count}} fascia/e palestra',
  hallImpactClosures: '{{count}} chiusura/e',
  hallImpactTrainings: '{{count}} allenamento/i',
  hallImpactGames: '{{count}} partita/e',
  hallImpactUnknown: 'Impossibile verificare cosa dipende da questa palestra.',
} as const
