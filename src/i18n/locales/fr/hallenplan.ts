export default {
  ...
  hallDeleteConfirm: 'Supprimer "{{name}}" ? Les creneaux, entrainements et matchs dans cette salle doivent d\'abord etre deplaces.',
  hallInUse: 'Cette salle a encore des creneaux. Supprimez-les d\'abord.',
