export default {
  ...
  hallDeleteConfirm: '"{{name}}" lösche? Das cha nöd rückgängig gmacht werde.',
  hallsEmpty: 'No kei Halle',
  hallImpactRemoved: 'Wird mitglöscht:',
  hallImpactKept: 'Bliibt bstoh, aber ohni Halle:',
  hallImpactSlots: '{{count}} Halleslot(s)',
  hallImpactClosures: '{{count}} Schliessig(e)',
  hallImpactTrainings: '{{count}} Training(s)',
  hallImpactGames: '{{count}} Spiel(e)',
  hallImpactUnknown: 'Het nöd chöne prüefe, was vo dere Halle abhanget.',
} as const
