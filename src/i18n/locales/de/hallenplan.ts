export default {
  ...
  hallDeleteConfirm: '"{{name}}" löschen? Slots, Trainings und Spiele in dieser Halle müssen zuerst verschoben werden.',
  hallInUse: 'Diese Halle hat noch Hallenslots. Diese zuerst entfernen.',
