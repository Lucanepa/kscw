export default {
  ...
  hallDeleteConfirm: 'Delete "{{name}}"? This cannot be undone.',
  hallsEmpty: 'No halls yet',
  hallImpactRemoved: 'Deleted with it:',
  hallImpactKept: 'Kept, but without a hall:',
  hallImpactSlots: '{{count}} hall slot(s)',
  hallImpactClosures: '{{count}} closure(s)',
  hallImpactTrainings: '{{count}} training(s)',
  hallImpactGames: '{{count}} game(s)',
  hallImpactUnknown: 'Could not check what depends on this hall.',
} as const
