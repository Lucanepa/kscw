export default {
  ...
  anmeldungenRecentLicence: 'Licence in the last two seasons?',
  anmeldungenRecentLicenceYes: 'Yes — Freibrief required',
  anmeldungenRecentLicenceNo: 'No — Freibrief waived',
  anmeldungenDocsWaive: 'Approve anyway',
  anmeldungenDocsWaiveTitle: 'Approve without the missing documents',
  anmeldungenDocsWaiveIntro: 'These documents will be waived for this registration and will no longer be requested:',
  anmeldungenDocsWaiveReasonLabel: 'Why can the licence be issued without them?',
  anmeldungenDocsWaiveReasonPlaceholder: 'e.g. Swiss Basketball confirmed by email on 09.09.2026 that the Freibrief is not needed',
  anmeldungenDocsWaiveConfirm: 'Waive and approve',
  anmeldungenDocsWaivedLabel: 'Documents waived',
  anmeldungenDocsWaivedToast: 'Approved — {{count}} document(s) waived.',
