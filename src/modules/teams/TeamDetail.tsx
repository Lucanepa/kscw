  ...
  return (
    <div>
      <div className="mb-6 flex items-center gap-2 text-sm text-gray-500">
        ...
        <span>/</span>
        <span className="text-gray-900">{team.full_name}</span>
      </div>
      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl font-bold text-gray-900">{team.full_name}</h1>
          </div>
      ...
      <div className="mt-8">
        <h2 className="text-lg font-semibold text-gray-900">Kader ({members.length})</h2>
